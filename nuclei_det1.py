...
#code written for data science bowl Kaggle, SC, jan 18 ,v3 
#keras and TF based  for nuclei images
...
# fitting
results = model.fit(X_train, Y_train, validation_split=val_split, batch_size=8, epochs=n_epochs)#callbacks=[earlystopper, checkpointer])
